...
## Algorithms ![](CC-BY-NC-SA.png)

<https://github.com/UPPMAX/programming_formalisms/blob/main/testing/testing_lecture/testing_lecture.qmd>
...
-   `find_mismatch_positions`, `find_mismatch_loci`, `get_mismatch_positions`,
    `get_mismatch_loci`
-   you answer that ...
    1.  starts with a verb
    2.  is as English as possible
...
-   `align_seqs`, `align_sequences`, `align_dna_sequences`, 
    `align_dna_seqs`, `calc_aligned_seqs`, `get_aligned_seqs`
-   you answer that ...
    1.  starts with a verb
    2.  is as English as possible
    3.  only uses common abbreviations
...
Function names start with lowercase character, 
name does not start with a verb, 
