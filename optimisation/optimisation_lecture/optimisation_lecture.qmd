...
-   Depends on proportion spent in
    the parallelized part @rodgers1985improvements
-   Overhead is underestimated
-   Hard to debug

## Bad advice 3

![amdahls_law.png](https://en.wikipedia.org/wiki/File:AmdahlsLaw.svg#file)

## Bad advice 4

'Optimize the function where 
you feel the performance problem is'
...
-   The 90-10 rule: 
    90% of all time, the program spends in 10% of the code.
