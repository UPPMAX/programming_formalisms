...
that can be found [at the learners' project website](https://github.com/programming-formalisms/programming_formalisms_project_summer_2026/blob/master/docs/requirements.md).
