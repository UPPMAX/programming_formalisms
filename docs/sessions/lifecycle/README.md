...
???- info "Example flow chart of a requirement described as a User story or Use Case"
    ...
    From example [requirement specification](../project_start/analysis_design/README.md):
...
- [A short introductory text to SDLC and modeling](../development_design/software_development_process.md)
