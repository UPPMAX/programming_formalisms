...
???- info "Summary of `[Alkaoud and Walcott, 2018]`"
...
???- info "Summary of `[Allen and Mehler, 2019]`"
...
???- info "Summary of `[Aniley et al., 2024]`"
...
???- info "Summary of `[Beelders and du Plessis, 2015]`"
...
???- info "Summary of `[Bergström and Moberg, 2002]`"
...
???- info "Summary of `[Bhat and Nagappan, 2006]`"
...
???- info "Summary of `[Chacon and Straub, 2014]`"

    This is *the* book about Git. I (Richel) do not think this book
    is suitable for beginners, however.
...
???- info "Summary of `[Erdogmus and Morisio, 2005]`"
...
???- info "Summary of `[Forsgren et al., 2018]`"
...
???- info "Summary of `[Kline and Seffah, 2005]`"
...
???- info "Summary of `[Kroll et al., 2013]`"
...
???- info "Summary of `[Leau et al., 2012]`"
...
???- info "Summary of `[Li and Ahmed, 2023]`"
...
???- info "Summary of `[Madeyski et al., 2010]`"
...
???- info "Summary of `[Munafò et al., 2017]`"
...
???- info "Summary of `[Pastrana et al., 2025]`"
...
???- info "Summary of `[Serban et al., 2020]`"
...
???- info "Summary of `[Soderberg et al., 2021]`"
...
???- info "Summary of `[Stodden and Miguez, 2014]`"
...
???- info "Summary of `[Sutter and Alexandrescu, 2004]`"
...
???- info "Summary of `[Wilson et al., 2014]`"
...
???- info "Summary of `[Wilson et al., 2017]`"
...
???- info "Summary of `[Yas et al., 2023]`"
