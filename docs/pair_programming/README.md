...
- what is for sure: it works great with recommended teaching practices,
  ...
  [as they write in the retrospective](https://github.com/UPPMAX/programming_formalisms/blob/main/retrospectives/2023_autumn/retrospective_results_course.md)
