...
- [R, FYI, 3 mins] R made a more detailed overview at
  `[the now broken link at `
  `https://uppmax.github.io/programming_formalisms/intro]`,
  with project exercises at the bottom. Maybe you find it helpful too?
