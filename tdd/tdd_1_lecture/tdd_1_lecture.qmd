...
[https://youtu.be/VddlrNOeodg](https://youtu.be/VddlrNOeodg)
...
-   Arrange: what is before
-   Act: do it
-   Assert: there must have been a change
 ...
 * Create a GitHub repository called `add_one`
 * Share URL of repo with teachers
 * Develop a function called `add_one`
 * Try to be **exemplary**
 * We'll discuss a repo history after the break
 ...
 * The literature assumes a responsible programmer writes tests \[1,2,3\]
